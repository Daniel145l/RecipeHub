...
export const Home = () => {
  ...
  return (
    <div className='p-4 flex flex-col justify-center gap-4 lg:px-12'>
      ...
      {loading ? (
        <p className='text-green-700 font-bold text-center'>Carregando receitas</p>
      ) : (
       <motion.div className='w-full mx-auto grid grid-cols-1 px-8 gap-12 text-center lg:grid-cols-2 lg:px-12'
